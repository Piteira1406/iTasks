...
class _UserEditScreenState extends State<UserEditScreen> {
  ...
  // Armazenar os dados originais do Manager/Developer para preservar o docId
  ...
  void initState() {
    ...
    // Fetch managers and load user data
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      // Se estiver editando, carregar dados específicos do perfil
      if (_isEditing) {
  ...
  Future<void> _loadUserProfileData() async {
    ...
    if (widget.user!.type == 'Manager') {
      // Carregar dados do Manager usando o UID
      ...
      // Carregar dados do Developer usando o UID
  ...
  void _saveForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (_isEditing) {
        ...
        // Create role-specific objects with IDs and docId preserved
